...
<!-- ### 태그 선택자
특정 태그를 선택하여 해당 태그를 조작하는 데 사용됩니다.
````html
$("p")
````
위 예제는 p 요소를 선택합니다.
...
위 예제는 #gnb 요소를 선택합니다.
### 클래스 선택자
특정 클래스를 가진 모든 요소를 선택하여 조작합니다.
````html
#(".logo")
````
위 예제는 .logo인 요소를 선택합니다.
### 자식 선택자
특정 요소의 직계 자식 요소를 선택하여 조작합니다.
````html
$("#gnb > ul > li")
````
위 예제는 #gnb의 자식 요소의 자식 요소 li를 선택합니다.
### 하위 선택자
특정 요소의 모든 자식 요소를 선택하여 조작합니다.
````html
$("#gnb ul")
````
위 예제는 #gnb의 하위에 있는 모든 ul 요소를 선택합니다.
### 인접 선택자
지정된 요소의 바로 뒤에 있는 형제 요소를 선택하여 조작합니다.
````html
$("#visual + #content")
````
위 예제는 #visual 다음에 오는 #content 요소를 선택합니다.
### 형제 선택자
특정 요소와 같은 부모를 가진 모든 형제 요소를 선택하여 조작합니다.
````html
$("#visual ~ #footer")
````
위 예제는 #visual의 형제 요소 #footer를 선택합니다.
### 종속 선택자
하위 선택자와 유사하지만, 상위 요소와 하위 요소 간의 관계가 명확하지 않을 때 사용됩니다.
````html
&("div.until")
````
위 예제는 div 요소 중 class가 until인 요소를 선택합니다.
### 그룹 선택자
여러 선택자를 동시에 사용하여 하나의 선택자 그룹을 형성하여 조작합니다.
````html
$(".left .right. #banner")
````
위 예제는 .left .right. #banner 요소들을 선택합니다.
### 전체 선택자
문서 내의 모든 요소를 선택하여 조작합니다.
````html
$("*")
````
위 예제는 모든 요소를 선택합니다. -->
